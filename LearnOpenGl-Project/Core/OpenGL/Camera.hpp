...
public:
    ...
    Frustum GetFrustum() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            frustum.planes[i].normal.x = viewProjMatrix[0][3] + sign * viewProjMatrix[0][col];
            frustum.planes[i].normal.y = viewProjMatrix[1][3] + sign * viewProjMatrix[1][col];
            frustum.planes[i].normal.z = viewProjMatrix[2][3] + sign * viewProjMatrix[2][col];
            frustum.planes[i].d = viewProjMatrix[3][3] + sign * viewProjMatrix[3][col];
